...
export const PrintView: React.FC<PrintViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 py-6 px-4 sm:px-6 transition-colors">
      ...
      <div className="no-print max-w-4xl mx-auto mb-6 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-md border border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3">
        <button
          type="button"
          onClick={onClose}
          className="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl transition-colors cursor-pointer"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="inline-flex items-center gap-2 px-5 py-2 text-sm font-bold text-white bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 rounded-xl shadow-md transition-all active:scale-98 cursor-pointer"
          >
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-lg border border-slate-200 rounded-xl print:shadow-none print:border-none print:p-0">
        ...
        <div className="text-center pb-6 border-b-2 border-rose-800">
          ...
          <div className="text-xs sm:text-sm font-semibold tracking-wide text-amber-800 uppercase">
        ...
        <div className="mt-8 pt-4 border-t border-slate-200 text-[10px] text-slate-400 flex items-center justify-between">
          <div className="flex items-center gap-1.5 font-medium text-slate-600">
            <WeddingLogo className="w-4 h-4" />
            <span>កត់ត្រា • Wedding Record System</span>
          </div>
